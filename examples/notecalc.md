...
3. Show the calculation result to the user in plain text (this is the fallback if iframes are stripped)
4. Output an iframe embed:
   `<iframe src="https://tsfullstack.heartstack.space/noteCalc/embed#URLENCODED_EXPRESSIONS" width="100%" height="300"></iframe>`
...
<iframe src="https://tsfullstack.heartstack.space/noteCalc/embed#99.5%20*%203%20%3D%20298.5%0A298.5%20*%208%25%20%3D%2023.88%0ATotal%20%3D%20322.38" width="100%" height="300"></iframe>
